...
KOBJS := assert.o run.o mtimer.o IRQ_handler.o SWI_handler.o hanlder_installer.o C_SWI_handler.o C_IRO_handler.o main.o math.o memcheck.o raise.o ctype.o hexdump.o device.o
KOBJS := $(KOBJS:%=$(KDIR)/%)
